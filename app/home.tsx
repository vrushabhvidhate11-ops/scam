            ...
            <AnimatePresence mode="wait">
              ...
              {step === stepStates.SCHEDULE && (
                ...
                >
                  ...
                  {error && (
                    <p className="mt-4 rounded-3xl bg-rose-100/90 px-4 py-3 text-center text-sm text-rose-700 shadow-sm">
                      {error}
                    </p>
                  )}
                  ...
                  {celebrating && (
                    <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-white/10">
                      ...
                      <div className="relative z-10 grid gap-3 text-center">
                        <p className="text-sm uppercase tracking-[0.28em] text-pink-500">celebration</p>
                        <h2 className="text-3xl font-semibold text-rose-950">YAY! It&apos;s a date! 💕</h2>
                        <p className="text-sm text-rose-700">We&apos;re locked in for {formattedDate} at {formattedTime}. I can&apos;t wait.</p>
                      </div>
